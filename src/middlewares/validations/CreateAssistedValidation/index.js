  ...
  const schema = Yup.object().shape({
    ...
    address: Yup.object().shape({
      ...
      cep: Yup.number()
        ...
        .typeError('O código postal deve ser um numero'),
      referencePoint: Yup.string()
        .required('Um local de referência deve ser informado')
    ...
    cpf: Yup.string()
      ...
      .typeError('O cpf deve ser um texto contendo números'),
    ...
    hasARelativeAttended: Yup.boolean()
      ...
      .typeError('Se ja teve um parente atendido deve ser verdadeiro ou falso'),
    ...
    governmentProgramValue: Yup.number()
      .positive()
      .required('O valor que recebia do programa do governo deve ser informado')
    ...
    nisNumber: Yup.number()
      .positive()
      .required('O número de indexificação social deve ser informado')
    ...
    schooling: Yup.object().shape({
      ...
      hasMemberMatriculatedOrWillMatriculate: Yup.boolean()
        .required(
          'Se possui um familiar matriculado ou a que ainda vai se matricular em uma instituição de ensino deve ser informado',
        )
        .typeError(
          'Se possui um familiar matriculado ou a que ainda vai se matricular em uma instituição de ensino deve ser verdadeiro ou falso',
        ),
    }),

    property: Yup.object().shape({
      type_property: Yup.string()
        .required('o tipo de propriedade que possui deve ser informado')
        .typeError('O tipo de propriedade que possui deve ser um texto'),
      physical_structure: Yup.string()
        .required('A estrutura física deve ser informado')
        .typeError('A estrutura física ser um texto'),
      numberOfRooms: Yup.number()
        .positive()
        .required('O numero de quartos deve ser informado')
        .typeError('O numero de quartos deve ser um número valido'),
      ...
      monthlyFinancing: Yup.number()
        ...
        .typeError('O financiamento mensal deve ser um texto'),
      isSharedWithOtherFamily: Yup.boolean()
        .required('Se é compartilhado com outros familiares deve ser informado')
        .typeError(
